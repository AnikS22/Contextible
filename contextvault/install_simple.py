...
def show_success():
    ...
    print("      ollama serve")
    print()
    print("   2. Start the Contextible proxy (in a NEW terminal):")
    print("      python scripts/ollama_proxy.py")
    print()
    print("   3. Now use your AI as normal - it will remember you!")
    print("      • Open Ollama app and chat normally")
    print("      • Or use: curl http://localhost:11435/api/generate")
    print()
